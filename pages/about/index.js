    ...
    info: [
      {
        ...
        icons: [
          ...
          <FaReact />,
          <SiNextdotjs />,
          <SiFramer />, // Assuming Splinter is replaced with Framer
          <SiAdobephotoshop />, // For Tailwind substitute icon
          <SiAdobexd />, // Assuming Django
          <FaFigma />, // Assuming Node.js (as placeholder, replace if needed)
        ],
      },
      {
                ...
                >
                  ...
                  <div className="flex gap-x-4">
                    {item.icons?.map((icons, itemIndex) => {
                      return (
                        <div className="text-2xl text-white ">{icons}</div>
                      );
                    })}
                  </div>
                </div>
